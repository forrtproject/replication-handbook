...
While the number of replication and reproduction studies has increased, the overall proportion of them is still very small, with replications accounting for about 1% of publications in high-impact psychology journals [@MakelEtAl2012] and for well below that in education, at roughly 0.2% of publications per year [@PerryEtAl2022]. Moreover, much of the guidance on replications is still being developed [@ClarkeEtAl2026] and in narrow parts of science, which leads to fragmentation, siloing, and potentially inconsistent information.
