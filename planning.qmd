...
statistics via the website statcheck.io (where documents may be
uploaded), the corresponding R package [@NuijtenPolanin2020], or
papercheck [@papercheckR], which is still actively maintained.
