...
| Type | Description |
|----|----|
| FORRT Library of Replication Attempts (FLoRA) | This open and collaborative database contains thousands of replication findings and makes them visible. Anyone can enter results using a guided survey (<https://forrt.org/replication-hub/submit>). |
