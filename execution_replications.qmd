...
replication itself reaches significance, it asks whether the original
study was ever in a position to detect the effect it claimed. The
...
power a significant original result is more likely to have been a false
positive than a detection of a real effect. The approach is particularly
...
principled criterion for when such shrinkage is large enough to conclude
that the original study could not have provided reliable evidence in the
first place.
...
result, whereas from a deductive, theory-focused perspective, only
changes that bear on the underlying theory are consequential. Keeping
