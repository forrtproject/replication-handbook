...
[-@BrandtEtAl2014] but it may not fit the structure of some studies
beyond social psychology (e.g., personality science or cognitive
psychology; for a list of preregistration templates see
<https://osf.io/7xrn9> and <https://osf.io/zab38/wiki/home>). To
...
Reports (irrespective of replications) is [available
online](https://docs.google.com/spreadsheets/d/1D4_k-8C_UENTRtbPzXfhjEyu3BfLxdOsn9j-otrO870/edit#gid=0).
...
documentation, see @Lakens2024, and @WillrothAtherton2024. If changes
are noticed during the data collection, many platforms also allow the
upload of amendments with preserved version history.
...
-   [Adding checks:]{style="text - decoration: underline;"} Doing a
    ...
    the experiment), or attention checks. See Frank et al. (2025,
    [chapter
    12.3](https://experimentology.io/012-collection.html#ensuring-high-quality-data))
...
-   Powers et al. [-@PowersEtAl2013] investigated the effect of video
    games on information processing and found larger effect sizes for
    active research groups.

-   Ten effects from Open Science Collaboration
    [-@OpenScienceCollab2015] were replicated in Many Labs 5
    [@EbersoleEtAl2020], where the original authors commented on the
    study protocols of the planned replication before these replications
    were conducted, and “the revised protocols produced effect sizes
    similar to those of the RP:P protocols (Δr = .002 or .014, depending
    on analytic approach).”

-   McCarthy et al. [-@McCarthyEtAl2021] conducted a multisite
    replication of hostile priming where one of the original authors was
    involved. Each laboratory conducted a close and a conceptual
    replication and found no difference and recommended that
    “researchers should not invest more resources into trying to detect
    a hostile priming effect using methods like those described in Srull
    and Wyer (1979)”.

-   After Baumeister and Vohs [-@BaumeisterVohs2016] criticized the
    failed registered replication report by Hagger et al.
    [-@HaggerEtAl2016] for their methods, Vohs et al. [-@VohsEtAl2021]
    conducted another registered replication report and also found a
    null effect.
...
-   After no effect of the pen-in-mouth task was found in the facial
    ...
    [-@WagenmakersEtAl2016], another multilab test, which included one
    of the original authors, arrived at the same results
    [-@ColesEtAl2022].
...
-   The Many Labs 4 project set out to test the effect of author
    ...
    findings’ authors [@KleinEtAl2014].
